...
//        driver = new ChromeDriver();
    ...
    void shouldTestNegativeFIO() {
        ...
        driver.findElement(cssSelector("[data-test-id='agreement']")).click();
        driver.findElement(cssSelector("[type='button']")).click();
        String actual = driver.findElement(cssSelector(".input_invalid .input__sub")).getText().trim();
    ...
    void shouldTestNegativeCheckbox() {
        ...
        driver.findElement(cssSelector("[type='button']")).click();
        String actual = driver.findElement(cssSelector(".input_invalid .checkbox__text")).getCssValue("color");
